...
public class ControlDeveloper {
	...
	public static void main(String[] args) {
		...
		/**
		 * @exception exercise
		 *                3 Polymorphie Objekt wird angelegt und mittels
		 *                Methoden aufgerufen
		 * @author Lukas Erkert
		 */
		...
		/**
		 * @exception exercise
		 *                4 Verkettete Liste Objekt commandList wird angelegt
		 *                Mittels add wird ein Array in der Klasse CommandList
		 *                angelegt Dieses Array wird dann mit "remove" "moveUp"
		 *                "moveDown" bearbeitet
		 * @author Lukas Erkert
		 */
	...
	/**
	 * @exception setzt
	 *                den String das er aufgerufen werden kann
	 * @param newName
	 * @author Lukas Erkert
	 */
	...
	/**
	 * @exception Array
	 *                [3] 0-3 wird angelegt das man nicht immer nochmal
	 *                schreiben muss
	 * @author Lukas Erkert
	 */
	...
	/**
	 * @exception printCommands
	 *                ruft die Klassen auf und printed von der jeweiligen Klasse
	 *                das toString
	 * @author Lukas Erkert
	 */
