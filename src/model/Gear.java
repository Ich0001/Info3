...
public class Gear extends Command implements IGear {
	 ...
	 * den Wert des jeweiligen Übergabeparameters.
	 * 
	 * @param speed
	 *            Legt beim Erzeugen des Objektes bereits fest, wie groß speed
	 *            ist.
	 * @param duration
	 *            Legt beim Erzeugen des Objektes bereits fest, wie groß
	 *            duration ist.
	 */
	 ...
	 * 
	 * @param speed
	 *            Der Wert für speed wird hier gesetzt bzw. überschrieben.
	 */
	 ...
	 * 
	 * @param duration
	 *            Der Wert für duration wird hier gesetzt bzw. überschrieben.
	 */
